...
namespace Force
{
    public class ForcePoint : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            allForcePoints = FindObjectsByType<ForcePoint>(FindObjectsSortMode.None).Where(p => p.ConnectedArticulationBody == ConnectedArticulationBody&& p.ConnectedRigidbody == ConnectedRigidbody).ToArray();
