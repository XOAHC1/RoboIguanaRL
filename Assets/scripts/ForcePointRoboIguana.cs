...
namespace RoboIguanaRL
{
    public class ForcePointRoboIguana : MonoBehaviour
    {
        ...
        private Vector3 pos, worldVelocity, localVelocity;
        ...
        {
            // let time to reset 
            if (resetting) {Debug.Log("happened");return;}

            // update position
            pos = transform.position;
            worldVelocity = GetPointVelocity(pos);
        ...
        public void ResetFP()
        {
            ...
            var xDrive = body.ab.xDrive;
            xDrive.target = 0f;
            body.ab.xDrive = xDrive;
